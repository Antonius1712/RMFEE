...
@section('content')
        ...
        <div class="card-body row" id="card-filter">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="broker_name" id="broker_name" class="form-control radius" value="{{ request()->get('broker_name') }}"
                ...
                <div class="form-group">
                    ...
                    <select name="status_pembayaran_premi" id="status_pembayaran_premi" class="form-control radius">
                        ...
                        @foreach ($statusPremi as $val)
                            <option {{ request()->get('status_pembayaran_premi') == $val ? 'selected' : '' }} value="{{ $val }}">{{ $val }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="start_date" id="start_date" class="form-control radius" value="{{ request()->get('start_date') }}"
                        placeholder="Type Here..">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="no_policy" id="no_policy" class="form-control radius" value="{{ request()->get('no_policy') }}"
                        placeholder="Type Here..">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="aging_rmf" id="aging_rmf" class="form-control radius" value="{{ request()->get('aging_rmf') }}"
                        placeholder="Type Here..">
                </div>
            </div>
            <div class="clearfix"></div>
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="booking_date_from" value="{{ request()->get('booking_date_from') }}">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <select name="nb_rn" id="nb_rn" class="form-control radius">
                        <option value="">All</option>
                        @foreach ($NBRN as $val)
                            <option {{ request()->get('nb_rn') == $val ? 'selected' : '' }} value="{{ $val }}">{{ $val }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="holder_name" id="holder_name" class="form-control radius" value="{{ request()->get('holder_name') }}"
                        placeholder="Type Here..">
                </div>
            </div>
            <div class="clearfix"></div>
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="text" name="booking_date_to" id="booking_date_to" class="form-control" value="{{ request()->get('booking_date_to') }}">
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <select name="ClassBusiness" id="ClassBusiness" class="form-control radius">
                        <option value="">All</option>
                        <option {{ request()->get('ClassBusiness') == '02-MOTOR VEHICLE' ? 'selected' : '' }} value="02-MOTOR VEHICLE">02-MOTOR VEHICLE</option>
                        <option {{ request()->get('ClassBusiness') == '01-PROPERTY' ? 'selected' : '' }} value="01-PROPERTY">01-PROPERTY</option>
                    </select>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <select name="status_realisasi" id="status_realisasi" class="form-control radius">
                        ...
                        @foreach ($statusRealisasi as $val)
                            <option {{ request()->get('status_realisasi') == $val ? 'selected' : '' }} value="{{ $val }}">{{ $val }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="form-group">
                    ...
                    <select name="status_budget" id="status_budget" class="form-control radius">
                        ...
                        @foreach ($statusBudget as $val)
                            <option {{ request()->get('status_budget') == $val ? 'selected' : '' }} value="{{ $val }}">{{ $val }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <button type="submit" id="btn_apply_filter" class="btn btn-primary waves-effect waves-light radius-100" style="width: 100%;">
                    Apply Filter
                </button>
            </div>
        </div>
    ...
    @php
        $toDoListVal = request()->has('to_do_list') && request()->get('to_do_list') != '' ? request()->get('to_do_list') : 'No';
        // dd($toDoListVal);
    @endphp
@endsection
