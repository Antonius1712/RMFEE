                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <input type="text" name="budget" id="budget" class="form-control col-lg-8"
                                    placeholder="Budget(%)" value="{{ $Budget->Persentage }}" readonly>
                            </div>
                            <div class="form-group row">
                                ...
                                <input type="text" name="budget_in_amount" id="budget_in_amount"
                                    ...
                                    value="{{ number_format($Budget->Budget) }}" readonly>
                            </div>
                            <div class="form-group row">
                                ...
                                <input type="file" name="document" id="document"
                                    ...
                                    placeholder="Document" value="" readonly>
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" name="proposed_to_display" id="proposed_to_display"
                                    ...
                                    value="{{ isset(Auth()->user()->getUserSetting->Approval_BU_UserID) ? Auth()->user()->getUserSetting->Approval_BU_UserID .' - '. Auth()->user()->getUserSetting->getApprovalBUName() : '' }}"
                                    readonly>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-2">
                                    <a href="{{ route('budget.list') }}" id="btn_propose_budget"
