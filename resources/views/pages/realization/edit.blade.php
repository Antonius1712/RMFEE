                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-lg-1 col-form-label-lg">:</label>
                                <select name="type_of_invoice" id="type_of_invoice" class="form-control col-lg-8">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-lg-1 col-form-label-lg">:</label>
                                <input type="text" name="invoice_date" id="invoice_date" class="form-control col-lg-8" placeholder="Invoice Date" value="{{ date('d M Y', strtotime($RealizationData->Invoice_Date)) }}">
                            </div>
                            <div class="form-group row">
                                <label for="broker_id" class="col-lg-3 col-form-label-lg">Broker ID</label>
                                <label class="col-lg-1 col-form-label-lg">:</label>
                                <input type="text" name="broker_id" id="broker_id" class="form-control col-lg-8" placeholder="Broker ID" value="{{ isset($BrokerData) && $BrokerData != '' ? $BrokerData->ID : '' }}">
                            </div>
                            <div class="form-group row">
                                <label for="broker" class="col-lg-3 col-form-label-lg">Broker</label>
                                <label class="col-lg-1 col-form-label-lg">:</label>
                                <input type="text" name="broker" id="broker" class="form-control col-lg-8" placeholder="Broker" readonly value="{{ isset($BrokerData) && $BrokerData != "" ? $BrokerData->Name : "" }}">
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-lg-1 col-form-label-lg">:</label>
                                <input type="text" name="total_realization" id="total_realization" class="form-control col-lg-8" placeholder="Total Realization"  value="{{ number_format($TotalAmountRealized) }}" readonly>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-lg-1 col-form-label-lg">:</label>
                                <textarea name="remarks" id="remarks" cols="30" rows="10" class="form-control col-lg-8">{{ $RealizationData->Remarks }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
