...
@section('content')
    <div class="row">
        <div class="col-lg-12 mb-2">
            <a href="{{ route('realization.detail-realization.create') }}" class="btn btn-primary pull-right" style="border-radius: 100px; font-size: 18px;">
                            ...
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="BtnActionGroup">
                                        ...
                                        <a class="dropdown-item success" href="{{ route('realization.detail-realization.edit') }}">
